...
# =============================================================================
# Create a class variable for 1D LiS Model
# =============================================================================
...
class LiS_1D_Model:
    ...
    def __init__(self, x, I):
        ...
        ## x is the variable values array and I is applied current ##
        self.x = x
        self.I = I
        
    def get_func_vals(self):
        # =============================================================================
        # Reference the u array and jacobian from the func_1D_LiS.py script 
        # =============================================================================
        ## Reference u_list
    ...
    ## Use the code from func_1D_LiS.py
    # =============================================================================
    ...
    def jacobian(self, prevt_vals, dx, h):
        ...
        self.get_func_vals()
        x = self.x # Format similar to how the ovr_var_init list in func_1D_LiS.py script
        dx_dt = [dx, h, self.I]
        ...
        row_label = func.row_label ## Import row_label from func_1D_LiS.py script
        ...
        for i in range(num_rows):
            ...
            ## Handle for xL bounday point variables ##
                ...
                var_subs = []
                for j in range(num_var):
                    prevt = prevt_vals[j][num_space-1]
